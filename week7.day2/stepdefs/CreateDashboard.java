...
public class CreateDashboard extends ProjectSpecificMethods {
	...
	public void clickAccountDropdown() throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@id='dashboardNameInput']")).sendKeys("Salesforce Automation by Indhu");
		driver.findElement(By.xpath("//button[@id='submitBtn']")).click();
		driver.findElement(By.xpath("//button[text()='Save']")).click();
		String savedMessage = driver.findElement(By.xpath("//div[@id='toastDescription832:0']/span")).getText();
